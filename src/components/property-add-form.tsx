...
type OuterKeyType = 'location' | 'rates' | 'seller_info'
...
const PropertyAddForm = () => {
    ...
    const handleChange = (e: ChangeEvent<HTMLSelectElement | HTMLInputElement | HTMLTextAreaElement>) => {
        ...
        if (name.includes('.')) {
            const [outerKey, innerKey] = name.split('.') as [OuterKeyType, string]
    ...
    const handleImageChange = (e: ChangeEvent<HTMLInputElement>) => {
        ...
        if (files) updatedImages.push(...files)
        ...
        <>
            {mounted && (
                <form action='/api/properties' method='POST' encType='multipart/form-data'>
                    ...
                    <div>
                        <button
                            className='bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline disabled:bg-slate-800'
                            type='submit'>
                            Add Property
                        </button>
                    </div>
